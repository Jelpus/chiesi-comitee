  ...
  if (unmappedRows.length === 0 && mappedRows.length === 0) {
    return (
      <div className="rounded-[24px] border border-slate-200/80 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)]">
        <p className="text-sm text-slate-600">No DDD products detected yet.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-[24px] border border-slate-200/80 bg-white p-5 shadow-[0_10px_30px_rgba(15,23,42,0.05)]">
        ...
        >
          <div>
            <p className="text-[11px] uppercase tracking-[0.16em] text-slate-500">DDD Mapping</p>
            <p className="mt-1 text-sm font-medium text-slate-900">
              Unmapped DDD Products ({unmappedRows.length})
            </p>
          </div>
            ...
            <table className="min-w-full border-collapse">
              ...
              <tbody>
                ...
                {unmappedRows.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="px-3 py-4 text-sm text-slate-600">
                      All detected DDD products are already mapped.
                    </td>
                  </tr>
                ) : null}
              </tbody>
