...
export function ExecutiveKpiCard({ item }: ExecutiveKpiCardProps) {
  ...
  return (
    <article className="group relative flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-slate-200/60 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-indigo-200 hover:shadow-[0_20px_48px_rgba(15,23,42,0.10)] 2xl:rounded-[22px]">
      ...
      <div className="flex flex-1 flex-col gap-4 p-5 lg:p-4 xl:p-5 2xl:p-6">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-2.5">
            ...
            <p className="text-[10.5px] font-semibold uppercase tracking-[0.20em] text-slate-400 lg:text-[10px] xl:text-[10.5px]">
              {item.module}
            </p>
          </div>
        ...
        {/* KPI title */}
        <h2 className="text-[17px] font-semibold leading-snug tracking-tight text-slate-900 lg:text-base xl:text-[18px] 2xl:text-xl">
          {item.kpi}
        </h2>
        ...
        <div>
          ...
          <span className="text-[32px] font-bold leading-none tracking-tight text-slate-900 lg:text-[28px] xl:text-[32px] 2xl:text-[36px]">
            {item.actual}
          </span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-1">
          <div>
            ...
            <p className="mt-1 text-sm font-semibold text-slate-800 lg:text-xs xl:text-sm 2xl:text-[15px]">
              {item.target}
            </p>
          </div>
          <div>
